    ...
    <footer className="text-white pt-12 pb-6 mt-20 border-t border-white/10">
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li>
              ...
              <a href="tel:+905389173143" className="hover:text-[#caa74d]">
                0 538 917 31 43
              </a>
            </li>
            <li>
              <span className="font-semibold text-white">Murat BAĞDEŞ</span><br />
              <a href="tel:+905335560278" className="hover:text-[#caa74d]">
                0 533 556 02 78
              </a>
            </li>
            <li className="mt-2">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><a href="/" className="hover:text-[#caa74d]">Anasayfa</a></li>
            <li><a href="/hakkimizda" className="hover:text-[#caa74d]">Hakkımızda</a></li>
            <li><a href="/urunler" className="hover:text-[#caa74d]">Ürünler</a></li>
            <li><a href="/iletisim" className="hover:text-[#caa74d]">İletişim</a></li>
          </ul>
        </div>
